...
class machina:
	...
	def run(self):
		try :
        		...
        		self.cur_state = self.graphe[state][event]
        		st = "Transition - Old State : "+state+"; Event : "+event+"; New state : "+self.cur_state
        		st = st+"; Action : "+self.graphe[state][event]
        		print st
        		return self.graphe[state][event]
